...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        mPageCtrl.currentPageIndicatorTintColor = [UIColor redColor];
...
- (void)reloadData{
    ...
    CGSize pointSize = [mPageCtrl sizeForNumberOfPages:_pageCount];
    
    CGFloat page_x = -(mPageCtrl.bounds.size.width - pointSize.width) / 2+40 ;
    
    [mPageCtrl setBounds:CGRectMake(page_x, mPageCtrl.bounds.origin.y,
                                      mPageCtrl.bounds.size.width, mPageCtrl.bounds.size.height)];
